...
/**
 * Convert 'px' value to corresponding 'rem' (root element) unit value.
 * @param { Number } px
 */
function px2rem (px) {
  let remStyle = (window.getComputedStyle(document.documentElement).fontSize)
  let remSize = remStyle.slice(0, remStyle.length - 2)
